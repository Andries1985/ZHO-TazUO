    ...
    internal class VersionHistory : Gump
    {
        private static string[] updateTexts = {
            "/c[white][2.6.0]/cd\n" +
                "- New World map. \n" +
                "- New UI. \n",
            "\n\n/c[white]For further information please visit our discord."
        };
        ...
        public VersionHistory() : base(0, 0)
        {
            ...
            _hit.MouseUp += (s, e) =>
            {
                Utility.Platforms.PlatformHelper.LaunchBrowser("https://zuluhotelomega.com");
            };
            ...
            _hit.MouseUp += (s, e) =>
            {
                Utility.Platforms.PlatformHelper.LaunchBrowser("https://discord.gg/SM679Ruf");
            };
        }
    }
}
